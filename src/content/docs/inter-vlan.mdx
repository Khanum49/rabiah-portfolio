...
import networkDiagram from '../../assets/images/inter-vlan/network-diagram.png';
...
<div class="my-6">
  <Image src={networkDiagram} alt="Inter-VLAN Routing Network Topology" class="max-w-full h-auto rounded shadow-md" />
</div>
