...
import pic1 from '../../assets/images/firewall/Picture1.jpg';
import pic2 from '../../assets/images/firewall/Picture2.jpg';
import pic3 from '../../assets/images/firewall/Picture3.png';
import pic4 from '../../assets/images/firewall/Picture4.jpg';
import pic5 from '../../assets/images/firewall/Picture5.png';
...
## UFW and its role in network security
...
1. Check if the UFW is already installed for which you can use the following command:
   ...
   <div class="text-center my-6">
    <Image src={pic1} alt="UFW Help Command Output" class="max-w-full h-auto mx-auto rounded shadow-md" />
   </div>
...
2. If the firewall isn't pre-installed, you can install it using the following commands and give sudo password when prompted:
   ...
   <div class="text-center my-6">
    <Image src={pic2} alt="UFW Installation Process" class="max-w-full h-auto mx-auto rounded shadow-md" />
   </div>
...
<div class="text-center my-6">
  <Image src={pic3} alt="UFW Enable Command" class="max-w-full h-auto mx-auto rounded shadow-md" />
</div>
...
1. To allow the incoming HTTP traffic on port 80, you will typically need to create a new rule that allows incoming TCP traffic using the following command:
   ...
   <div class="text-center my-6">
    <Image src={pic4} alt="Allow HTTP Traffic Rule" class="max-w-full h-auto mx-auto rounded shadow-md" />
   </div>
...
```
  ...
  <div class="text-center my-6">
    <Image src={pic5} alt="UFW Status Verification" class="max-w-full h-auto mx-auto rounded shadow-md" />
  </div>
